...
def get_saas_startup_example() -> CompanyContext:
    """
    Generic SaaS startup example.
    Demonstrates typical B2B SaaS company context.
    """
    return CompanyContext(
        company_url="https://saascompany.com",
        company_name="SaaS Company",
        industry="B2B Software",
        description="We help businesses streamline operations with cloud-based software solutions.",
        products_services=[
            "Project Management Platform",
            "Team Collaboration Tools", 
            "Analytics Dashboard"
        ],
        target_audience="Small to medium businesses looking to improve productivity",
        ...
        content_themes=["productivity", "project management", "team collaboration"]
    )


def get_agency_example() -> CompanyContext:
    """
    Marketing agency example.
    Shows how agencies can use the system.
    """
    return CompanyContext(
        company_url="https://marketingagency.com",
        company_name="Growth Marketing Agency", 
        industry="Digital Marketing",
        description="Full-service digital marketing agency specializing in growth hacking and performance marketing for B2B companies.",
        products_services=[
        ...
        target_audience="B2B companies with $1M+ revenue looking to scale marketing",
        brand_tone="data-driven, results-focused, strategic",
        pain_points=[
        ...
        content_themes=["growth marketing", "lead generation", "marketing automation", "B2B sales"]
    )
...
COMPANY_EXAMPLES = {
    ...
    "saas_startup": get_saas_startup_example(),
    "agency": get_agency_example()
}